    ...
    <div class="container">
        <form action="" method="POST" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="number" name="width" id="input" class="form-control" value="<?php if(isset($_POST['width'])) echo $_POST['width']?>" required="required">
                    </div>
                    <div class="col-sm-2">
                        Chiều cao:
                    </div>
                    <div class="col-sm-4">
                        <input type="number" name="height" id="input" class="form-control" value="<?php if(isset($_POST['height'])) echo $_POST['height']?>" required="required">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="border" id="input" class="form-control" value="<?php if(isset($_POST['border'])) echo $_POST['border']?>" required="required">
                    </div>
                    <div class="col-sm-2">
                        Canh lề:
                    </div>
