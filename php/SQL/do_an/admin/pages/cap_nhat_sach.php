...
if(isset($_POST['btn_save_them_sach'])){
    ...
    if($hop_le == true){//se xu ly save
        ...
        if($id_cap_nhat){
            ...
            ?>
            <script>
                alert('Có lỗi xãy ra trong quá trình cập nhật!');
            </script>
            <?php
        }
    }
    ...
    <form action="" method="POST" class="form-horizontal" role="form">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['ten_sach'])) echo $_POST['ten_sach'];
                        else if($thong_tin_sach_cap_nhat)
                        echo trim($thong_tin_sach_cap_nhat->ten_sach);
                        ?>" title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['sku'])) echo $_POST['sku']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->sku); ?>"  title="">
            </div>
        </div>
                    ...
                    foreach($ds_loai_sach as $item_loai_sach){
                        ...
                        if(count($item_loai_sach->ds_con)){
                            ...
                            <option value="<?php echo $item_loai_con->id; ?>" <?php if($item_loai_con->id == $thong_tin_sach_cap_nhat->id_loai_sach) echo 'selected = "selected"'?>>
                                <?php echo '___' . $item_loai_con->ten_loai_sach; ?>
                            </option>
                            <?php
                            }
                        }
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea name="gioi_thieu" id="input" class="form-control" rows="3">
                <?php if(isset($_POST['gioi_thieu'])) echo $_POST['gioi_thieu']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->gioi_thieu); ?>
                </textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['doc_thu'])) echo $_POST['doc_thu']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->doc_thu); ?>"  title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['so_trang'])) echo $_POST['so_trang']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->so_trang); ?>"  title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['ngay_xuat_ban'])) echo $_POST['ngay_xuat_ban']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->ngay_xuat_ban); ?>"  title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['kich_thuoc'])) echo $_POST['kich_thuoc']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->kich_thuoc); ?>"  title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['trong_luong'])) echo $_POST['trong_luong']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->trong_luong); ?>"  title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['don_gia'])) echo $_POST['don_gia']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->don_gia); ?>"  title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                value="<?php if(isset($_POST['gia_bia'])) echo $_POST['gia_bia']; else if($thong_tin_sach_cap_nhat) echo trim($thong_tin_sach_cap_nhat->gia_bia); ?>"  title="">
            </div>
        </div>
