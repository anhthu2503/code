...
if(isset($_GET['id_xoa'])){
    ...
    if($id_xoa){
        ...
        if($result){
            ...
            window.location.href = "/Thuzoi/php/SQL/do_an/admin/?page=sach";
            </script>
            <?php
        }
    }
...
?>
    ...
    function function_build_html(data_list){
        ...
        for(var i = 0; i < data_list.length; i++){
            ...
            <tr>
                ...
                <td>
                    <a href="/Thuzoi/php/SQL/do_an/admin/?page=sach&id_xoa=${data_list[i].id}" type="button" class="btn btn-danger" onclick="return recheck_delete(); ">
    ...
    function get_ds_sach_theo_trang(pageNumber){
        $.get('http://localhost:8080/Thuzoi/php/SQL/do_an/admin/api.php?trang=' + (pageNumber - 1))
            .done((data) => {
