...
if(isset($_POST['ho_ten_nguoi_nhan']) && isset($_SESSION['gio_hang'])){
    ...
    if($id_vua_them){
        ...
        $phpmail->Port = 465;
        $phpmail->IsHTML(true);
        $phpmail->Username = 'huynhanhthithu@gmail.com';
        $phpmail->Password = 'huynh262503';
        $phpmail->SetFrom("huynhanhthithu@gmail.com");
        $phpmail->From = "huynhanhthithu@gmail.com";
        $phpmail->Subject = "Cảm ơn bạn đặt hàng tại Bán sách online của chúng tôi";
        ...
        if(!$phpmail->Send()){
            echo "<script> alert('Trong luc gui mail xay ra su co: ".$phpmail->ErrorInfo."');</script>";
        }
        else{
            ...
            <script>
                ...
                window.location.href = '/Thuzoi/php/SQL/do_an/';
            </script>
            <?php
        }
