...
<body class="main_content">
    <div class="container-fluid">
        ...
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <div class="">
                <form action="/Thuzoi/php/SQL/do_an/?page=gio-hang" method="POST">
                    <input style="margin:10px 0 10px 0;"type="number" name="so_luong" id="input" class="form-control" value="" required="required" title="">
