...
class xl_sach extends database{
    ...
    function them_sach($ten_sach, $id_tac_gia, $gioi_thieu, $doc_thu, $id_loai_sach, $id_nha_xuat_ban, $so_trang, $ngay_xuat_ban, $kich_thuoc, $sku, $trong_luong, $trang_thai, $don_gia, $gia_bia, $noi_bat){
        $string_sql = "INSERT INTO bs_sach (ten_sach, id_tac_gia, gioi_thieu, doc_thu, id_loai_sach, id_nha_xuat_ban, so_trang, ngay_xuat_ban, kich_thuoc, sku, trong_luong, trang_thai, don_gia, gia_bia, noi_bat)
        VALUES ('$ten_sach', '$id_tac_gia', '$gioi_thieu', '$doc_thu', '$id_loai_sach', '$id_nha_xuat_ban', '$so_trang', '$ngay_xuat_ban', '$kich_thuoc', '$sku', '$trong_luong', '$trang_thai', '$don_gia', '$gia_bia', '$noi_bat');";
        //echo $string_sql;exit;
        $this->setSQL($string_sql);
        $this->execute();
