...
<body>
    <div class="container">
        ...
        <?php
            $dir = opendir('images');
            while(($file = readdir($dir)) !== false){//$file co gia tri thi moi in ra
                if($file != '.' && $file != '..'){
                    ?>
        ...
        <form action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="file" name="hinh[]" id="input" class="form-control" multiple="true">
                    </div>
                </div>
