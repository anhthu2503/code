...
if($_FILES['hinh']){
    $thong_tin_hinh = $_FILES['hinh']['name'];
    move_uploaded_file($_FILES['hinh']['tmp_name'],'./images/',$thong_tin_hinh);
}

if(isset($_POST['ma_sach']) && isset($_POST['ten_sach']) && isset($_POST['don_gia']) && isset($_POST['tac_gia']) && isset($_POST['nha_xuat_ban']) && isset($thong_tin_hinh)){
